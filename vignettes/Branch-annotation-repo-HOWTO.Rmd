...
```sh
rsync --dry-run -ave \
ssh [biocadmin\@malbec1](mailto:biocadmin@malbec1){.email}:PACKAGES/3.6/data/annotation/ .
```
...
```sh
ssh [ubuntu\@master.biocondcutor.org](mailto:ubuntu@master.biocondcutor.org){.email} \
