...
No 3.16 build should start until the bump and branch process is complete and
`BBS_BIOC_GIT_BRANCH` is switched from `master` to `RELEASE_3_16` on the
central BioC 3.16 builder (this switch is documented in section F3 below).
...
to start before step F3 is completed.
...
Once you're done, don't forget to uncomment all the builds that were temporary
commented out in the crontab (see section C1 above).
